...
public interface IEnvironment : Antilatency.InterfaceContract.IInterface {
	...
	/// </param>
	Antilatency.InterfaceContract.Bool match(Antilatency.Math.float3[] raysUpSpace, out Antilatency.Alt.Tracking.MarkerIndex[] markersIndices, out Antilatency.Math.floatP3Q poseOfUpSpace);
	...
	Antilatency.Alt.Tracking.MarkerIndex[] matchByPosition(Antilatency.Math.float3[] rays, Antilatency.Math.float3 origin);
}
namespace Details {
